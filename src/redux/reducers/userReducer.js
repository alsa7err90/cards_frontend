...
: {};
const sales = JSON.parse(localStorage.getItem("sales")) ? JSON.parse(localStorage.getItem('sales'))
: {};
 
const logged = JSON.parse(localStorage.getItem("logged")) ? JSON.parse(localStorage.getItem('logged'))
: {};
const crypto =JSON.parse(localStorage.getItem("crypto")) ? JSON.parse(localStorage.getItem('crypto'))
: {};
const setting =JSON.parse(localStorage.getItem("setting"))? JSON.parse(localStorage.getItem('setting'))
: {};
const news =JSON.parse(localStorage.getItem("news")) ? JSON.parse(localStorage.getItem('news'))
: {};
...
: {};
const bouquets =JSON.parse(localStorage.getItem("bouquets")) ? JSON.parse(localStorage.getItem('bouquets'))
: {}; 
const theme =JSON.parse(localStorage.getItem("theme")) ? JSON.parse(localStorage.getItem('theme'))
: {};
const countNoty =JSON.parse(localStorage.getItem("countNoty")) ? JSON.parse(localStorage.getItem('countNoty'))
: {};
const noty =JSON.parse(localStorage.getItem("noty")) ? JSON.parse(localStorage.getItem('noty'))
: {};
...
const initialState = token 
  ...
  : { logged: false, token: null, userId: null, sales: null, 
    crypto: null,
    digital: null, 
    setting: null,
    news: null,
